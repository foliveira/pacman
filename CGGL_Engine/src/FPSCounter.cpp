...
namespace cggl {
  ...
  void FPSCounter::Draw() 
  {
    ...
    // "FPS:"
    glColor3f(1,1,0);
	cggl::App::Writer->WriteImediateText(x, 20, "FPS:", GLUT_BITMAP_HELVETICA_12);

    // Desenho de texto "multiplo"
    glColor3f(1, 1, 1);
    cggl::App::Writer->BeginWriteText();
    cggl::App::Writer->WriteText(x+10,  40, txtFPSIns, GLUT_BITMAP_HELVETICA_12);
    cggl::App::Writer->WriteText(x+10,  60, txtFPSAve, GLUT_BITMAP_HELVETICA_12);
